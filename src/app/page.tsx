  ...
  const teams = [
    {
      ...
      description: "Sharpen your algorithms and compete globally in prestigious programming competitions",
      icon: FaTrophy,
      color: "#004AAD",
    ...
    },
    {
      ...
      description: "Defend networks, learn cybersecurity, and protect against real-world threats",
      icon: FaShieldAlt,
      color: "#58cbf7",
    ...
    },
    {
      ...
      description: "Build real applications, gain industry experience, and create impactful solutions",
      icon: FaCode,
      color: "#004AAD",
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <motion.h1
                {...fadeInUp}
                transition={{ ...fadeInUp.transition, delay: shouldReduceMotion ? 0 : 0.2 }}
              ...
              <motion.p
                {...fadeInUp}
                transition={{ ...fadeInUp.transition, delay: shouldReduceMotion ? 0 : 0.4 }}
                className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto"
              >
                Empowering the next generation of computer scientists at California Baptist University
              </motion.p>
              
              <motion.div
                {...fadeInUp}
                transition={{ ...fadeInUp.transition, delay: shouldReduceMotion ? 0 : 0.6 }}
                className="flex flex-col sm:flex-row gap-6 justify-center"
              >
                <Link href="/login" className="group relative bg-[#58cbf7] hover:bg-[#004AAD] text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                  <span className="relative z-10">Join ACM Today</span>
                </Link>
                <Link href="/teams" className="group border-3 border-white text-white hover:bg-white hover:text-[#004AAD] font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105">
                  Explore Teams
                </Link>
              </motion.div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join one of our specialized teams and dive deep into your passion for technology
            </p>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className={`w-16 h-16 bg-gradient-to-br ${team.gradient} rounded-2xl flex items-center justify-center shadow-lg transition-transform duration-200 group-hover:scale-105`}>
                      <IconComponent className="text-white text-2xl" />
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-bold text-[#004AAD]">{team.name}</div>
                      <div className="text-sm text-gray-500 font-medium">
                        {team.members || team.projects} {team.members ? 'Members' : 'Projects'}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${team.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
                </motion.div>
              );
            })}
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Start your journey with ACM @ CBU today and connect with like-minded students who share your passion for technology
            </p>
            <Link 
              href="/login" 
