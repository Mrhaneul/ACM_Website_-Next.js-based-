...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white text-black p-4 border-b-[6px] border-[#004AAD] relative z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            />
            <span
              className={`font-black ${isDesktop ? "text-xl" : "text-base"}`}
            >
      ...
      {!isDesktop && (
        <div
          className={`fixed top-[88px] left-0 right-0 bg-white shadow-lg transition-all duration-300 ease-in-out z-40 ${
            isMenuOpen
